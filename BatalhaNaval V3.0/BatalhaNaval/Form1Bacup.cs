...
namespace BatalhaNaval
{
    public partial class Form1 : Form
    {
        ...
        int vezes5 = 0, vezes4 = 0, vezes3 = 0, vezes2 = 0, vezes1 = 0;
        ...
        int barco1 = 1, barco2 = 1, barco3 = 1, barco4 = 1, barco5 = 1;
        ...
        public Form1()
        {
            ...
            MessageBox.Show("Regras do jogo : " +
                    "\n" +
                    "\n" +
                    "1 ) Clique nos botoes com nome de navios\n\n" +
                    "2 ) Em linha reta no tabuleiro a sua frente, va clicando e colocando seus barcos.\n\n" +
                    "3 ) Escolha a dificuldade que você vai jogar." +
                    "\n" +
                    "\n#Te desafio a ganhar no IMPOSSIVEL#\n" +
                    "\n" +
                    "E tente acerta os navios do seu inimigo, " +
                    "clicando no segundo tabuleiro.\n\n" +
                    "Informações : \n\n" +
                    "Se seu navio ficar amarelo {Destruido}\n" +
                    "Se o do seu inimigo ficar vermelho {Destruido}\n" +
                    "Ambos os lados se ficar azul o tiro foi perdido\n\n" +
                    "#############    BOM JOGO !!!   #################### "
                    );
        ...
        public void evento_click(object sender, EventArgs e)
        {
            ...
            if (quantidade >= 1)      // Sistema que limita o usuario a só por seus barcos em linha reta
            {
                ...
                if (manual.Count > 0)
                {
                    ...
                    if (unidade == 0 && manual[cornenada] == manual[cornenada + 1] - 10 && b.BackColor != Color.Red || unidade == 0 && manual[cornenada] == manual[cornenada + 1] + 10 && b.BackColor != Color.Red)
                    {
                    ...
                    {
                        if (dezena == 0 && manual[cornenada] == manual[cornenada + 1] - 1 && b.BackColor != Color.Red || dezena == 0 && manual[cornenada] == manual[cornenada + 1] + 1 && b.BackColor != Color.Red)
                        {
            ...
            {
                porta_avioes.Visible = false;
                bcouracado.Visible = false;
        ...
        private void Bdificil_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Você vai perder !!!" +
                "\n\nAgora não tem regras!☠☠ )");
        }

        private void TocarSom(UnmanagedMemoryStream som)
        {
            // Resource1.cannon
            System.Media.SoundPlayer sfx = new System.Media.SoundPlayer(som);
            sfx.Play();
        }
